...
<%
	...
	String language = LanguageUtil.get(request.getLocale(), "oc_language");
%>
	...
	<form:form name="startpageSearch" action="${metaDataActionUrl}"
		...
		<fieldset>
			...
			<br /> <label for="website"><liferay-ui:message
					key="website" /></label>
			<form:input id="website" path="url"
				placeholder='<%= websitePrompt %>' />
		...
		<fieldset>
			...
			<form:input id="temporal_coverage_from" path="temporal_coverage_from"
				placeholder='<%= temporal_coverage_fromPrompt %>' readonly="true" />
			...
			<form:input id="temporal_coverage_to" path="temporal_coverage_to"
				placeholder='<%= temporal_coverage_toPrompt %>' readonly="true" />
